== forge2512
:idprefix: id_ 
(choose one, do not modify, then add a second sentence with a brief description, starting with - "The forge2512 addon enables blah blah...)
...
<dependency>
   ...
   <artifactId>forge2512</artifactId>
